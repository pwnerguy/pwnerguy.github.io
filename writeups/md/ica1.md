...
![](/assets/images/ica1/arp_scan.png)

After identifying the target's IP address, we need to enumerate as  much information as possible about the host.

A quick way to get a hint of the OS is checking the TTL value from a simple ping to a host on our local network. [**ttl-ripper.sh**](https://github.com/pwnerguy/ttl-ripper) can also be used for this purpose.
* TTL 64: Linux.
* TTL 128: Windows.

In this case, it appears to be a Linux machine.

![](/assets/images/ica1/nmap1.png)
...
![](/assets/images/ica1/codename.png)
...
![](/assets/images/ica1/whatweb.png)
...
![](/assets/images/ica1/web.png)

![](/assets/images/ica1/wappalyzer.png)

-----------
## Vulnerability Assessment

![](/assets/images/ica1/searchsploit.png)

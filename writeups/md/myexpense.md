...
![](/assets/images/myexpense/arp-scan.png)
...
![](/assets/images/myexpense/whichSystem.png)

Now we will perform a port scan on the machine. To work in an organized way we will use the function **mkt**.

![](/assets/images/myexpense/mkt.png)

![](/assets/images/myexpense/nmap_scan.png)

![](/assets/images/myexpense/extractPorts.png)

![](/assets/images/myexpense/targeted1.png)

![](/assets/images/myexpense/targeted2.png)
...
![](/assets/images/myexpense/launchpad.png)
...
![](/assets/images/myexpense/whatweb.png)

![](/assets/images/myexpense/web.png)

![](/assets/images/myexpense/wappalyzer.png)
...
![](/assets/images/myexpense/gobuster1.png)
...
![](/assets/images/myexpense/gobuster2.png)
...
![](/assets/images/myexpense/admin.php.png)
...
![](/assets/images/myexpense/register.png)
...
![](/assets/images/myexpense/alert.png)
...
![](/assets/images/myexpense/pwned.js.png)
...
![](/assets/images/myexpense/stolen_cookie.png)
...
![](/assets/images/myexpense/750_sending.png)
...
![](/assets/images/myexpense/user_cookies.png)
...
![](/assets/images/myexpense/manon_riviere_accepts.png)

The **Rennes** panel is vulnerable to **SQLI**. We will follow the following exploitation:

![](/assets/images/myexpense/sqli1.png)

![](/assets/images/myexpense/sqli2.png)

![](/assets/images/myexpense/sqli3.png)

![](/assets/images/myexpense/sqli4.png)

Finally, we obtain a string of users and passwords. We will format it with nvim to make it more readable.

![](/assets/images/myexpense/hashes.png)
...
![](/assets/images/myexpense/cracked_hash.png)

To finish, we will log in as pbaudouin and send ourselves the €750.

![](/assets/images/myexpense/expense_reports.png)

To obtain the flag we must log in as slamotte.

![](/assets/images/myexpense/flag.png)

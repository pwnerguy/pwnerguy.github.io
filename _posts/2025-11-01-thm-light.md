...
excerpt: I’m currently working on a database application called Light! Would you like to give it a try? If so, the service is already up and running on port 1337. You can connect directly to it using the command nc MACHINE_IP 1337. To get started, simply log in with the username smokey. From there, you’ll be able to interact with the application, explore its features, and see how it handles different inputs. This challenge is designed to help you practice connecting to custom services and experimenting with database-style interactions in a hands-on way.
date: 2025-11-1
classes: wide
header:
...
# Introduction
-------------
This writeup documents the penetration testing of the [**Light**](https://tryhackme.com/room/lightroom) machine from the [**TryHackMe**](https://tryhackme.com/) platform.

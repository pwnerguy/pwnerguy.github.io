...
# Introduction
-------------
This writeup documents the penetration testing of the [**ICA: 1**]([ICA: 1 ~ VulnHub](https://www.vulnhub.com/entry/ica-1,748/)) machine. This machine has been downloaded from the [**VulnHub**](https://vulnhub.com) platform. 

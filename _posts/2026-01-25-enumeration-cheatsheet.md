...
| ---------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| **Service Scanning**                                                                                             |                                                                               |
| `nmap -p- --open -sS --min-rate 5000 -vvv -n -Pn 10.10.10.10 -oG allPorts`                                       | Nmap custom basic port scan redirecting the output to a fiile called allPorts |
| `nmap -sCV -p21,22,80 10.10.10.10`                                                                               | Nmap basic recon scripts scan over speccific ports                            |
| `nmap --script smb-os-discovery.nse -p21,22,80 10.10.10.10`                                                      | Run an nmap script on an IP                                                   |
| ``nmap -sV --script=banner -p21,22,80 10.10.10.10``                                                              | Run a nmap script for Banner Grabbing                                         |
...
| `echo '' > /dev/tcp/10.10.10.10/`                                                                                | Communications to /dev/tcp, an alternative to ICMP                            |
| **Web Enumeration**                                                                                              |                                                                               |
...
| `smbclient //10.10.10.10/share -N`                                                                               | Connect to an SMB share as 'guest' to see files                               |
